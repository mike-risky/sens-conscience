      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center pt-36 pb-48">
        ...
        >
          <img
            ...
            className="h-52 md:h-72 lg:h-80 w-auto"
          />
        </motion.div>
        ...
        <motion.blockquote
          ...
          className="font-heading italic text-white text-2xl md:text-3xl lg:text-4xl leading-relaxed mb-14 max-w-2xl mx-auto bg-[#3A2E22]/45 backdrop-blur-md rounded-2xl px-8 py-6 shadow-lg shadow-black/20"
        >
