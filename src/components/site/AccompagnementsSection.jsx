...
const services = [
  {
    ...
    text: "Un espace confidentiel pour prendre du recul et retrouver une direction.",
  },
  {
    title: "Transitions de vie",
    text: "Traverser un changement sans perdre votre axe.",
  },
  {
    title: "Marche narrative",
    text: "Un accompagnement en mouvement, dans la nature, pour libérer la parole.",
  },
  {
    title: "À la rencontre de soi",
    text: "Mieux comprendre votre fonctionnement et vos besoins.",
  },
  {
    title: "Schémas répétitifs",
    text: "Identifier les mécanismes qui se répètent et y répondre autrement.",
  },
  {
    title: "Reprendre les rênes de sa vie",
    text: "Sortir du sentiment d'impuissance et retrouver une marge de choix.",
  },
  {
    title: "Hypersensibilité, HPI et TDAH",
    text: "Comprendre et apprivoiser un fonctionnement atypique.",
  },
  {
    title: "Retrouver le goût de sa vie",
    text: "Renouer avec ce qui donne du sens et de l'énergie.",
  },
];
