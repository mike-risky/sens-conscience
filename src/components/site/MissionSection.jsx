      ...
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            <img
              src={MISSION_IMG}
              alt="Feuille séchée et galet posés sur lin parchemin, près de Sion — la clarté retrouvée"
              className="w-full max-w-md mx-auto lg:mx-0 rounded-lg object-cover aspect-[4/5] shadow-lg shadow-[#292824]/10"
            />
          </div>
          ...
          <div>
            ...
            >
              ...
              <p className="font-body text-[#6E6A62] text-base md:text-lg leading-relaxed max-w-xl">
